    ...
    definiData(self): 
      ...
      defgetX(self): 
        ...
        while xRet=='' or (False == self.isNumber(xRet))\ 
                  or 0>int(xRet) orint(xRet)>self.ROW: 
      ...
      defgetY(self): 
              ...
              while yRet=='' or (False == self.isNumber(yRet))\ 
                        or 0>int(yRet) orint(yRet)>self.LINE: 
                      print 'Wrong number!(please input 0-7)' 
                      sys.stdout.write('Y=') 
                      yRet = raw_input() 
              return int(yRet) 
      ...
      defdisplay(self,kind): 
              ...
              if kind==1: 
                      ...
                      for i in range(self.LINE): 
                              ...
                              print '|' 
                      print '*-----------------*' 
                      print 'Please input values ofx,y(0-7):'                    
              else: 
                      #输出所有的地雷与已经清扫位置 
                      print '*-----------------*' 
                      for i in range(self.LINE): 
